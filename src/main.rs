...
use cli::diff::colorize_unified_diff;
use cli::errors::render_cli_error;
use cli::process::{
    build_context, collect_targets, compile_file_filter, describe_cli_overrides,
    describe_config_mode, process_targets, resolve_config_context, resolve_config_probe_target,
    FailedTarget, InputTarget, ProcessedTarget, ProgressReporter,
};
use cli::report::{machine_mode_exit_code, print_non_human_report};
use cli::summary::{
    render_explain_output, render_human_summary, render_stat_summary, render_summary_failed_line,
    render_summary_line,
};
...
use cmakefmt::{
    ...
    files::{discover_cmake_files_with_options, is_cmake_file, DiscoveryOptions},
    format_source_with_registry, generate_json_schema, parser, render_effective_config, CaseStyle,
