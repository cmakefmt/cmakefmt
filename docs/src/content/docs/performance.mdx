...
- **22.18×** geometric-mean speedup over `cmake-format` on real-world CMake files
...
- Fastest individual fixture: **58.48×** speedup (`xnnpack/CMakeLists.txt`, 1354 lines)
...
Per-fixture speedup. The dashed line marks the geometric mean (`22.18×`).
